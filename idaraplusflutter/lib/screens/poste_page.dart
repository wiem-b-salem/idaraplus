...
class PostePage extends StatefulWidget {
  ...
  @override
  PostePageState createState() => PostePageState();
}
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildActionButton('Colis Postaux', Icons.local_shipping),
              _buildActionButton('Compte Postal', Icons.account_balance),
              _buildActionButton('Connaître les tarifs', Icons.price_check),
              _buildActionButton('Horaires d\'ouverture', Icons.schedule),
              _buildActionButton('Contacter le Poste', Icons.phone),
